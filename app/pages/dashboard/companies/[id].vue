...
<template>
  <div class="max-w-2xl mx-auto">
    <!-- Título -->
    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Editar Compañía</h2>
...
// Datos mockados (después conectar a API)
const form = ref({
...
const handleSubmit = () => {
  ...
  console.log('Formulario actualizado:', form.value, 'ID:', id)
